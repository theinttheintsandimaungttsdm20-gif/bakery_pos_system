...
public class OrderView extends JPanel {
	...
	private JButton btnAddIngeridents;
	...
	public OrderView() {
		...
		add(getBtnAddIngeridents());

	}

	public JLabel getLblEmployeeForm() {
		if (lblEmployeeForm == null) {
			lblEmployeeForm = new JLabel("ORDERS Form");
	...
	public JButton getBtnAddIngeridents() {
		if (btnAddIngeridents == null) {
			btnAddIngeridents = new JButton("ADD Ingeridents");
			btnAddIngeridents.setFont(new Font("Tahoma", Font.BOLD, 14));
			btnAddIngeridents.setBounds(496, 181, 191, 23);
		}
		return btnAddIngeridents;
	}
}
