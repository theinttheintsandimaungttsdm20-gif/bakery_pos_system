...
public class ReportOrdersView extends JPanel {
	/**
	 * 
	 */
	...
	public JLabel getLblEmployeeForm() {
		if (lblEmployeeForm == null) {
			lblEmployeeForm = new JLabel("ORDERS REPORT");
	...
	public JLabel getLblStartDate() {
		if (lblStartDate == null) {
			lblStartDate = new JLabel("Start Order Date :");
			lblStartDate.setFont(new Font("Tahoma", Font.PLAIN, 14));
			lblStartDate.setBounds(22, 100, 111, 24);
		}
		return lblStartDate;
	}
	...
	public JLabel getLblEndDate() {
		if (lblEndDate == null) {
			lblEndDate = new JLabel("End Order Date:");
			lblEndDate.setFont(new Font("Tahoma", Font.PLAIN, 14));
			lblEndDate.setBounds(389, 100, 119, 24);
		}
		return lblEndDate;
	}
	public JDateChooser getDateEnd() {
		if (dateEnd == null) {
			...
			dateEnd.setBounds(518, 100, 200, 24);
		}
		return dateEnd;
	}
	...
	public JLabel getLblSelectSalesReport() {
		if (lblSelectSalesReport == null) {
			lblSelectSalesReport = new JLabel("Select Orders Report Type:");
